...
class CadastroCliente {
    ...
    public cadastrar(): void {
        console.log("---------------------------------------");
        console.log(`\nIniciando o cadastro do cliente`);
...
class AlteracaoCliente {
    ...
    public alterarCliente() {
        console.log("---------------------------------------");
        console.log("\nIniciando a alteração do cliente");
...
class ExclusaoCliente {
    ...
    public deletar(): Array<Cliente>{
        console.log("---------------------------------------");
        console.log("\nIniciando a exclusão do cliente");
...
class ListaCliente {
    ...
    public listarClientes(): void {
        ...
        if (produtoEspecifico.toUpperCase()==='S'){
            while (true) {
...
function exibirDetalhesCliente(cliente: Cliente) {
    ...
    if (cliente.getProdutosConsumidos.length === 1) {
        ...
        console.log(`- Data: ${cliente.getProdutosConsumidos[0].dataConsumo}`)
        ...
        cliente.getProdutosConsumidos.forEach((produtoData, index) => {
            ...
            console.log(`- Data: ${produtoData.dataConsumo}`)
            console.log(`- Pet: ${produtoData.pet.getNome}`)
        })
    }

    if (cliente.getServicosConsumidos.length === 1) {
        console.log(`Serviço Consumido: ${cliente.getProdutosConsumidos[0].itemConsumido.getNome}`)
        console.log(`- Data: ${cliente.getServicosConsumidos[0].dataConsumo.getDay()}/${cliente.getServicosConsumidos[0].dataConsumo.getMonth()}/${cliente.getServicosConsumidos[0].dataConsumo.getFullYear()}`)
        console.log(`- Pet: ${cliente.getServicosConsumidos[0].pet}`)
    } else {
        cliente.getServicosConsumidos.forEach((servicoData, index) => {
            ...
            console.log(`- Data: ${servicoData.dataConsumo.getDay()}/${servicoData.dataConsumo.getMonth()}/${servicoData.dataConsumo.getFullYear()}`)
...
function receberPreferenciaNomeSocial(entrada: Entrada): string {
    while (true) {
