                                    ...
                                    default:
                                        if ([2,3].includes(alteracaoDesejada)){
                                            ...
                                            if (telefoneEscolhido === 0){
                                                ...
                                                this.clienteEncontrado.setTelefones(
                                                    this.clienteEncontrado.getTelefones.filter(
                                                        telefoneData => telefoneData !== this.clienteEncontrado.getTelefones[telefoneEscolhido-1]
                                                    )
                                                )
                                            }
                                        } else{
