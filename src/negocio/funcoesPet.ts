    ...
    public cadastrar(): void {
        while (true) {
            ...
            if (clienteEncontrado) {
                console.log("-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=")
                while (true) {
                    console.log(`CADASTRANDO PET PARA O ${clienteEncontrado.nome.toUpperCase()}`)
                    console.log("----------------------------------------")
            ...
            console.log("========================================")
            console.log(`###### CADASTRO DO PET FINALIZADO ######`)
            break
        }
    }
}
class ListaPet {
    ...
    public listar(): void {
        console.log(`###### INICIANDO LISTAGEM DO PET  ######`)
        console.log("========================================")
        let petEspecifico = this.entrada.receberTexto(`Gostaria de procurar um pet em específico? (S/N): `)
        if (petEspecifico.toUpperCase() === 'S') {
            while (true) {
                let petEscolhido = buscarPet(this.clientes, this.entrada, false)
                if (petEscolhido instanceof Pet) {
                    console.log("-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=")
                    console.log(`Dados do Pet:\n`)
                    exibirDetalhesPet(petEscolhido)
                    console.log("-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=")
                    let continuar = this.entrada.receberTexto(`Deseja listar mais algum pet? (S/N)`)
        ...
        console.log("========================================")
        console.log(`###### LISTAGEM DO PET FINALIZADA ######`)
    }
}
class AlteracaoPet {
    private clientes: Array<Cliente>
    ...
    public alterar(): void {
        console.log(`###### INICIANDO ALTERAÇÃO DO PET ######`)
        console.log("========================================")
        while (true) {
            console.log("-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=")
        ...
        console.log("========================================")
        console.log(`##### ALTERAÇÃO DO PET FINALIZADA  #####`)
    }
}
...
class ExclusaoPet {
    ...
    public deletar(): void {
        console.log(`###### INICIANDO EXCLUSAO DO PET  ######`)
        console.log("========================================")
        const petSelecionado = buscarPet(this.clientes, this.entrada, false)
        if (!(petSelecionado instanceof Pet)) {
        ...
        console.log("========================================")
        console.log(`###### EXCLUSAO DO PET FINALIZADA ######`)
    }
}
